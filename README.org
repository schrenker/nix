...
- [[#yasnippets][Yasnippets]]
  - [[#disable-doom-provided-snippets][Disable doom provided snippets]]
  - [[#set-snippets-directory-to-reside-in-doomdir][Set snippets directory to reside in doomdir]]
...
* Yasnippets
- I really like behaviour of easy-templates in org-mode where you can use <s and other to expand into blocks
- Since I use tng, almost all snippets are useless and conflict with it
- In my case, I want to create templates, that when launched are completed, with no jumping around between fields
** Disable doom provided snippets
#+begin_src emacs-lisp :tangle packages.el
(package! doom-snippets :ignore t)
#+end_src

** Set snippets directory to reside in doomdir
#+begin_src emacs-lisp :tangle config.el
