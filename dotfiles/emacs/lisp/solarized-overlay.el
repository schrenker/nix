...
(defun schrenker/solarized-theme-overlay (appearance)
  ...
  (let ((yellow    "#b58900")
      ...
      (progn
        ...
        (set-face-attribute 'org-level-1 nil :background orange-1bg :extend t)
        (set-face-attribute 'org-level-2 nil :background green-1bg :extend t)
        (set-face-attribute 'org-level-3 nil :background blue-1bg :extend t)
        (set-face-attribute 'org-level-4 nil :background yellow-1bg :extend t)
        (set-face-attribute 'org-level-5 nil :background cyan-1bg :extend t)
        (set-face-attribute 'org-level-6 nil :background green-1bg :extend t)
        (set-face-attribute 'org-level-7 nil :background red-1bg :extend t)
        (set-face-attribute 'org-level-8 nil :background blue-1bg :extend t)
