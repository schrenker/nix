...
Naming format of these files are: tag:FILETAG.org. Update these files."
  ...
  (setopt schrenker/org-fileslug "${slug}.org"
          org-roam-capture-templates `(("p" "Project" plain "%?"
                                       ...
                                       ("rR" "Runbook" plain "%?"
                                        :target (file+head
                                                 ,(concat "02_resources/runbooks/" schrenker/org-fileslug)
...
(use-package eat
  ...
  (("C-c v" . eat-project)
   ...
   ("C-c 1" . (lambda () (interactive) (schrenker/eat-project)))
   ("C-c 2" . (lambda () (interactive) (schrenker/eat-project 2)))
   ("C-c 3" . (lambda () (interactive) (schrenker/eat-project 3)))
   ("C-c 4" . (lambda () (interactive) (schrenker/eat-project 4)))
...
If motion mode, switch to normal mode."
    (interactive)
    (cond ((and meow-normal-mode (eq (meow--mode-get-state) 'motion)) (meow--switch-state 'motion))
          (meow-motion-mode (meow--switch-state 'normal))
          (meow-beacon-mode nil)
          (t (meow--switch-state 'normal))))
